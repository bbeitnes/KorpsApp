...
- [ ] Skriv et ordentlig `package.json` og commit det. Det ligger allerede
...
- [ ] Sett opp Tailwind CLI (ikke PostCSS-plugin — ingen annen byggekjede
...
- [ ] Legg byggesteget inn i **alle fire** deploy-workflowene før
